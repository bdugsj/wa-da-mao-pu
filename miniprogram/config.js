...
module.exports = {
  ...
  app_version: "v1.2.0",
  // laf后台服务地址
  laf_url: 'https://r7got1.laf.run',
  // laf后台服务地址（微信开发工具中），一般和上面laf_url一致就好
  laf_dev_url: 'https://r7got1.laf.run',
  // 使用私有的腾讯云cos存储，需要url签名
  use_private_tencent_cos: true,

  // 科普页图片
  science_imgs: [
    "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/科普1.png",
    "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/科普2.png",
    "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/科普3.png",
    "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/科普4.png",
    "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/科普5.png"
  ],

  // 赞赏码图片
  reward_img: "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/赞赏码.jpg",
  // 新猫问卷图片
  feedback_wj_img: "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/猫猫问卷.png",
  // 小程序菊花码图片
  mpcode_img: "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/小程序码.jpg",

  // 徽章排行榜的数量榜logo
  badge_rank_count_img: "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/badge_rank_count.png",
  // 徽章排行榜的价值榜logo
  badge_rank_score_img: "https://cats-1306273238.cos.ap-nanjing.myqcloud.com/badge_rank_score.png",
  ...
  text: {
    ...
    reward: {
      ...
      reward_tip: "您的投喂及广告收入将用作猫猫救助，每月的收支都会在“窊大救助”公众号进行公开，感谢您对窊大救助的帮助与支持！\n*注：投喂时请备注猫猫或者狗狗，并附上您的签名以方便我们公式哦~喵(^･ｪ･^)",
    ...
    feedback: {
      ...
      contract_tip: "有关猫猫信息添加、小程序的建议、照片维权、猫猫领养咨询等事项，请关注窊大救助公众号后留言，或邮件：wadajiuzhu@163.com",
    },
    // 开发团队页，pages/info/devTeam/devTeam
    dev_team: {
      share_tip: "开发团队",
      team: "程序开发：中大猫谱开源项目团队\n二次开发：骨头\n资料维护：小韩学姐,倩倩和全体猫协成员\n非常欢迎新朋友加入设计开发~！",
    },
